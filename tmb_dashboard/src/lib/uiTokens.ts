...
export const inputBaseClass =
  'h-9 rounded-xl border border-[#cfdcec] bg-white px-3 text-sm outline-none focus:border-[#7ca4db] focus:ring-2 focus:ring-[rgba(30,99,201,0.15)]';

export const timelineItemClass = 'rounded-xl border border-[#e5edf7] bg-white p-3';
