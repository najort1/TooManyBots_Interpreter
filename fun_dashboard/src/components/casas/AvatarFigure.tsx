...
export function AvatarFigure({ avatar, label }: AvatarFigureProps) {
  ...
  return <div className="avatar-figure" aria-label={label || "Avatar"}>
    <div className="avatar-figure-art">
      <svg viewBox="0 0 180 240" role="img" shapeRendering="geometricPrecision">
        ...
        {outfit === "jaqueta_neon" && <><path d="M64 116h52M90 116v61" fill="none" stroke="#ffe082" strokeWidth="4" strokeLinecap="round" /><path d="M64 118l20 21 6-18m26-3-20 21-6-18" fill="none" stroke="#ff82ba" strokeWidth="5" strokeLinejoin="round" /></>}
        {outfit === "terno_suspeito" && <><path d="M90 111v69M65 116l25 24 25-24" fill="none" stroke="#1e2a45" strokeWidth="5" strokeLinejoin="round" /><path d="M90 121l8 10-5 27h-6l-5-27z" fill="#a33b4d" stroke="#562331" strokeWidth="3" strokeLinejoin="round" /></>}
        ...
        {accessory === "coroa_papel" && <path d="M54 37l10-27 22 21L90 6l7 25 20-21 10 27v13H54z" fill="#ffe082" stroke="#754e24" strokeWidth="5" strokeLinejoin="round" />}
        {accessory === "corrente_brilho" && <><path d="M67 117q23 29 46 0" fill="none" stroke="#ffd34f" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" /><circle cx="90" cy="139" r="7" fill="#ffd34f" stroke="#7b4d1b" strokeWidth="3" /><circle cx="88" cy="137" r="2" fill="#fff3b0" /></>}
      </svg>
    </div>
